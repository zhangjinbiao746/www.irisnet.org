    ...
    <div class="home_banner_container">
        <div class="home_banner_wrap" :style="{ height: `${curHeight}rem` }">
            <div class="home_banner_text_wrap" :style="{ left: curLeft }">
                <img
                    class="home_banner_text"
                    src="../../../assets/home/irishub2_text.png"
                    alt=""
                    :style="{ width: curWidth('5.68') }"
                />
                <a
                    class="home_banner_discord"
                    href="https://discord.gg/bmhu9F9xbX"
                    target="_blank"
                    rel="noreferrer noopener"
                >
                    <img
                        class="discord_normal"
                        src="../../../assets/home/discord.png"
                        alt=""
                        :style="{ width: curWidth('3.72') }"
                    />
                    <img
                        class="discord_hover"
                        src="../../../assets/home/discord_hover.png"
                        alt=""
                        :style="{ width: curWidth('3.72') }"
                    />
                </a>
...
<style scoped lang="less">
    .home_banner_container {
        ...
        .home_banner_wrap {
            ...
            margin: 0 auto;
            height: 10.8rem;
            background: url(../../../assets/home/shouping_bg.jpg) no-repeat center center;
            ...
            @media (max-width: 800px) {
                height: 10.8rem;
                background: url(../../../assets/home/shouping_800.jpg) no-repeat center / cover;
            }
            @media (max-width: 460px) {
                background: url(../../../assets/home/shouping_375.jpg) no-repeat center / cover;
            }
