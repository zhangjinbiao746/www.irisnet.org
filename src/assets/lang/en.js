export const message = {
    ...
    home: {
        ...
        sectionThree: {
            title: 'Roadmap',
            road: [
                {id: 0, caption: 'HOUYI', time: 'BEYOND JUL 2020', msg: 'The fourth stage will focus on further technology innovations to the IRIS network, SDK and mobile client, as well as developer engagement.'},
                {id: 1, caption: 'KUAFU', time: 'NOV 2019 - JUN 2020', msg: 'In this stage we are aiming to accomplish the connection of IRIS Hub with applications blockchains through IBC. We plan to upgrade IRISnet mobile client to support those applications. The third stage will also focus on upgrades to the IRIS network in order to support our planned advanced IRIS Service features.'},
