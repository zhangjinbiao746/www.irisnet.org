export default {
            ...
            "list": [
                {
                    ...
                    "txt": "作为 IRISnet 项目的第一阶段，我们将专注于构建 IRISnet，以及完成 Cosmos 生态中第一个区域性枢纽 IRIS Hub 和 Cosmos Hub的链接。同时，我们将发布一个初始版本的IRIS网络移动客户端。"
                },
                {
                ...
                },
                {
                    ...
                    "txt": "第三阶段主要专注于完成IRIS网络的增强功能，升级网络以支持复杂的IRIS服务管理功能，例如：分析和争议解决; 不断完善SDK和手机客户端; 加速拓展网络，连接更多的分区，整合更多的服务提供商。"
                },
                {
                    "img": "roadmap/houyi.png",
                    "txt": "通过不懈的技术创新，完善的社区建设和可持续的开发者支持以实现分布式商业生态系统。"
                }
            ]
        },
        "home": {
    ...
    en:{
        ...
        hackathon:{
            ...
            award:'Prizes： The bounty pool is of 212,500IRIS tokens. It is designed to be distributed in the following way: First Prize：25,000 IRIS tokens/team, 3 teams Second Prize: 12,500 IRIS tokens/team, 5 teams Third Prize: 6,250 IRIS tokens/team, 10 teams Participation Prize:125 IRIS tokens/team, 100 teams',
