export default {
  cn: {
      ...
      list: [
        {
          ...
          txt:
            "作为 IRISnet 项目的第一阶段，我们将专注于构建 IRISnet，以及完成 Cosmos 生态中第一个区域性枢纽 IRIS Hub 和 Cosmos Hub的链接。同时，我们将发布一个初始版本的IRIS网络移动客户端。",
        },
        {
          img: "roadmap/NUWA.png",
          txt:
            "在这一阶段，我们将建立 IRISnet 基本服务层： 升级网络以实现服务定义、绑定、调用和查询; 为开发者准备了beta版的IRIS SDK，并升级移动客户端以支持IRIS服务; 与分布式应用链项目形成战略联盟，支持应用链（分区）连接IRIS枢纽。",
        },
        {
          img: "roadmap/kuafu.png",
          txt:
            "第三阶段主要专注于完成IRIS网络的增强功能，升级网络以支持复杂的IRIS服务管理功能，例如：分析和争议解决; 不断完善SDK和手机客户端; 加速拓展网络，连接更多的分区，整合更多的服务提供商。",
        },
        {
          img: "roadmap/houyi.png",
          txt:
            "通过不懈的技术创新，完善的社区建设和可持续的开发者支持以实现分布式商业生态系统。",
        },
      ],
    },
    home: {
    ...
    hackathon: {
      ...
      subTitle: "",
      introduce:
        "活动介绍：为了鼓励更多的技术人员加入IRISnet社区并且参与到测试网中，IRISnet和Dorahacks正在寻找最优秀的黑客来参加到这场攻防游戏中。让我们一起来寻找使区块链网络更加安全可靠的新解决方案吧！",
      contestTime: "比赛时间：2018.9.3~2018.9.23",
      target: "招募对象：全球各地对IRISnet感兴趣的技术人员,1-3 人一组。",
      secreat:
        "取胜秘诀：熟悉Tendermint共识 熟悉Cosmos-SDK代码 熟悉IRISHub代码 熟悉区块链网络安全。",
    ...
    testnet: {
      ...
      howToJoin: "如何加入伏羲测试网",
      howToJoinHref:
        "https://www.irisnet.org/docs/get-started/Join-the-Testnet.html",
      faq: "IRIShub常见问题",
  ...
  en: {
    ...
    home: {
      title: "IRIS Network",
      txt:
        "Inter-chain Service Infrastructure and Protocol <br> Technology Foundation for a Distributed Business Ecosystem",
      src: "iristext-small.png",
    },
    about: {
    ...
    hackathon: {
      ...
      introduce:
        "Introduction: The IRIS network will keep generating value when its validators could keep the whole network secure. Dorahacks believe hackathons will generate the most impressive solutions for protecting a Proof-of-Stake blockchain.",
      contestTime: "Schedule Date: 2018.9.3~2018.9.23",
      target:
        "Who should join: Hackers who are interested in IRISnet around the world. Everyone is welcomed to form a team of 1 to 3 people.",
      secreat:
    ...
    newHackathon: {
      title: "Joining the Game of Genesis",
      introduction:
        "Introduction: The IRIS network will keep generating value when its validators could keep the whole network secure. Hackathons are built for rapid innovation. IRISnet & Dorahacks believe hackathons will generate the most impressive solutions for protecting a Proof-of-Stake blockchain.",
  ...
  cosmos: {
    en: {
      header: {
        ...
        guideHref:
          "https://hub.cosmos.network/master/hub-overview/overview.html#cosmos-hub-wallets",
      },
      about: {
