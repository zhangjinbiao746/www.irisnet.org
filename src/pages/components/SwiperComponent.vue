<template>
  <div>
    ...
    >
      ...
      >
        <swiper-slide
          v-for="(item, index) in $store.state.messages.homeBanner"
          :key="index"
        >
          <div
            class="banner_content_wrap"
            :style="{ background: `url(${item.padImage})` }"
          >
